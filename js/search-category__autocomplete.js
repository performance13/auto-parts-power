// Автокомплит
// Реализован в секции: Выбор запчастей по категориям
// https://www.youtube.com/watch?v=MmeN3fbDJ6g&ab_channel=MakeWeb.me
// https://github.com/makewebme/javascript-razbor/tree/master/simple-js-autocomplete
  ...
  inputs.forEach(input => {
    ...
    input.addEventListener('input', () => {
      ...
      data.forEach((dataItem, index) => {
        ...
        // красный цвет выделеного фрагмента в автокомплит
        item.innerHTML = parts[0] + '<mark>' + parts[1] + '</mark>' + parts[2];
